<?php
    ...
    (
        ...
        18 =>array(
            'Question' => '<img src="img/18.jpg" alt=""> <br> 18. After the snap, Thanos "retired" in a garden with a prominent rice terraces landscape. Can you take a wild guess where that actual terraces are located?',
            'Answers' => array(
                'A' => 'New Zealanad ',
                'B' => 'Canada ',
                'C' => 'Philippines',
        ...
        <?php 
            ...
            if (isset($_POST['answers']))
            {
                ...
                echo "<div class='container'>
                    ...
                    foreach ($Question as $number => $value){
                        echo "<div class='cotainer'>";
                        // Echo the question
                        echo $value['Question'].'<br />';

                        if ($ans[$number] != $value['CorrectAnswer'])
                        {
                            echo 'You answered: <span style = "color: red; ">' . $value['Answers'] [$ans[$number]] . '</span><br>';
                            echo 'Correct answer: <span style = "color: green; ">' . $value['Answers'] [$value['CorrectAnswer']] . '</span>';
                        } 
                        else 
                        {
                            echo 'Correct answer: <span style="color: green;">'.$value['Answers'][$ans[$number]].'</span><br>';
                            echo 'You are correct: <span style="color: green;">'.$value['Answers'][$ans[$number]].'</span>'; 
                            $correct++;
                        }
                        echo "<div>";
                        echo '<br />';
                    ...
                    echo "<br>";
                    echo $results;
                    echo "<button><a href='index.php?retake' class='start'>Take Again</a></button>";
            ...
            ?>
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" id="quiz">
                        <?php foreach ($Question as $number => $value){ ?>

                            <center><div class = 'container'>
                                <h3><?php echo $value['Question']; ?></h3>
                                <?php 
                                    foreach ($value['Answers'] as $Letter => $Answer){ 
                                    $Label = 'question-'.$number.'-answers-'.$Letter;
                                ?>
                                <div>
                                    <input type="radio" name="answers[<?php echo $number; ?>]" id="<?php echo $Label; ?>" value="<?php echo $Letter; ?>" required/>
